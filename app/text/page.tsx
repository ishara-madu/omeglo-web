...
export const metadata: Metadata = {
  ...
  keywords: [
    "free anonymous text chat with strangers",
    "stranger chat without camera or webcam",
    "omegle text chat alternative no login",
    "random text chat online no registration",
    "talk to strangers private text chat",
    "anonymous camera-free messaging with strangers",
    "fast random text chat in browser",
    "omegle text mode replacement 2026",
    "safe text chat with strangers online",
  ],
  alternates: {
